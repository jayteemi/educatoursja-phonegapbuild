...
.factory('$mmSitesManager', ["$http", "$q", "$mmSitesFactory", "md5", "$mmLang", "$mmConfig", "$mmApp", "$mmUtil", "$mmEvents", "mmCoreSitesStore", "mmCoreCurrentSiteStore", "mmCoreEventLogin", "mmCoreEventLogout", "$log", "mmCoreEventSiteUpdated", "mmCoreEventSiteAdded", "mmCoreEventSessionExpired", function($http, $q, $mmSitesFactory, md5, $mmLang, $mmConfig, $mmApp, $mmUtil, $mmEvents,
...
.run(["$mmEvents", "mmCoreEventLogin", "mmCoreEventSiteUpdated", "$mmCoursesDelegate", function($mmEvents, mmCoreEventLogin, mmCoreEventSiteUpdated, $mmCoursesDelegate) {
...
angular.module('mm.core.sidemenu')
.controller('mmSideMenuCtrl', ["$scope", "$state", "$mmSideMenuDelegate", "$mmSitesManager", "$mmSite", "$mmConfig", "$mmEvents", "$timeout", "mmCoreEventLanguageChanged", "mmCoreEventSiteUpdated", function($scope, $state, $mmSideMenuDelegate, $mmSitesManager, $mmSite, $mmConfig, $mmEvents,
...
angular.module('mm.core.sidemenu')
.factory('$mmSideMenuDelegate', ["$log", function($log) {
...
.run(["$mmSideMenuDelegate", "$mmaCalendar", "$mmLocalNotifications", "$state", "$ionicPlatform", "$mmApp", "mmaCalendarComponent", "mmaCalendarPriority", function($mmSideMenuDelegate, $mmaCalendar, $mmLocalNotifications, $state, $ionicPlatform, $mmApp,
...
.config(["$stateProvider", "mmaFilesUploadStateName", function($stateProvider, mmaFilesUploadStateName) {
    $stateProvider
        .state('site.files', {
            url: '/files',
            views: {
...
.run(["$mmSideMenuDelegate", "$mmaFiles", "$state", "$mmSitesManager", "$mmUtil", "$mmaFilesHelper", "$ionicPlatform", "mmaFilesPriority", "$mmApp", function($mmSideMenuDelegate, $mmaFiles, $state, $mmSitesManager, $mmUtil, $mmaFilesHelper, $ionicPlatform,
...
.run(["$mmSideMenuDelegate", "$mmaFrontpage", "mmaFrontpagePriority", function($mmSideMenuDelegate, $mmaFrontpage, mmaFrontpagePriority) {
...
.config(["$stateProvider", "$mmUserDelegateProvider", "mmaMessagesSendMessagePriority", "mmaMessagesAddContactPriority", "mmaMessagesBlockContactPriority", function($stateProvider, $mmUserDelegateProvider, mmaMessagesSendMessagePriority, mmaMessagesAddContactPriority,
...
.run(["$mmSideMenuDelegate", "$mmaMessages", "$mmEvents", "$state", "$mmAddonManager", "$mmUtil", "mmCoreEventLogin", "mmaMessagesPriority", function($mmSideMenuDelegate, $mmaMessages, $mmEvents, $state, $mmAddonManager,
...
.run(["$log", "$mmSideMenuDelegate", "$mmaNotifications", "$mmPushNotificationsDelegate", "$mmUtil", "$state", "$mmAddonManager", "mmaNotificationsPriority", function($log, $mmSideMenuDelegate, $mmaNotifications, $mmPushNotificationsDelegate, $mmUtil, $state, $mmAddonManager,
...
angular.module('mm.addons.files')
.controller('mmaFilesIndexController', ["$scope", "$mmaFiles", "$mmSite", "$mmUtil", "$mmaFilesHelper", "$mmApp", function($scope, $mmaFiles, $mmSite, $mmUtil, $mmaFilesHelper, $mmApp) {
...
.controller('mmaMessagesContactsCtrl', ["$q", "$scope", "$mmaMessages", "$mmSite", "$mmUtil", "mmUserProfileState", function($q, $scope, $mmaMessages, $mmSite, $mmUtil, mmUserProfileState) {
...
angular.module('mm.addons.messages')
.factory('$mmaMessagesHandlers', ["$q", "$log", "$mmaMessages", "$mmSite", "$state", "$mmUtil", function($q, $log, $mmaMessages, $mmSite, $state, $mmUtil) {
